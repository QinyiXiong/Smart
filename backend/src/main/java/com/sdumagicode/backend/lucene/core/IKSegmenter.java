 ...
 * by Oolong studio
 */
package com.sdumagicode.backend.lucene.core;

import com.sdumagicode.backend.lucene.cfg.Configuration;
import com.sdumagicode.backend.lucene.cfg.DefaultConfig;
