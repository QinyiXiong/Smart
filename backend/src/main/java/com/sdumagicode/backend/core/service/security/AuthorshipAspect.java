package com.sdumagicode.backend.core.service.security;
...
public class AuthorshipAspect {
    ...
    @Pointcut("@annotation(com.sdumagicode.backend.core.service.security.annotation.AuthorshipInterceptor)")
